...
// ABI for Holonym Sybil resistance contract based on phone number
const PHONE_NUM_SR_ABI = [
  {
    inputs: [
...
export class HolonymPhoneNumProvider implements Provider {
  ...
  async verify(payload: RequestPayload): Promise<VerifiedPayload> {
    ...
    try {
      ...
      const contract = new Contract(PHONE_NUM_SR_ADDRESS, PHONE_NUM_SR_ABI, provider);
